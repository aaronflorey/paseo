...
Paseo supports every major coding agent: Claude Code, Codex, GitHub Copilot, OpenCode, Cursor, Gemini, Cline, Goose, Amp, Aider, and 30+ others. They run locally through each provider's CLI or integration; Paseo supervises the appropriate local runtime and handles I/O, persistence, git worktree isolation, schedules, and skills.
